...
(SELECT FRONTIERDOMAIN,LTRIM(TO_CHAR(TO_NUMBER(SUBSTR(MID, 2, 10),'000000000'),'999999999')) AS MID FROM FRONTIER_USER_MANAGEMENT WHERE MID = /*mymid*/) B
WHERE
 A.COMMENT LIKE ('%[@:'||(B.FRONTIERDOMAIN)||','||(B.MID)||']%')