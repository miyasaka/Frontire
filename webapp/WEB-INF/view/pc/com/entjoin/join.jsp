...
<title>[frontier]コミュニティに参加する</title>
				...
				<div class="listBoxMemberDelete">
					<div class="listBoxMemberDeleteTitle">
						<table class="list_ttl">
							<tr>
								<td class="ttl_name_sp"><div class="ttl_name inputColStick">参加確認</div></td>
							</tr>
						</table>
					</div>
					<div class="listBoxMemberDeleteBody">
						<span>「<b>${f:h(communityDto.comnm)}</b>」に本当に参加しますか？</span>
						<div class="listBoxHead listBoxHeadline clearfix">
							<div class="ttlHeadArea">
								<div class="btnArea">
									<input type="submit" name="join" value="はい" >
